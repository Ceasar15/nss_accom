# Generated by Django 3.2.4 on 2021-07-13 08:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tracking.newstudent')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_submitted', models.TimeField(default=django.utils.timezone.now)),
                ('annou_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_index_number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-date_submitted'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('complaint_status', models.CharField(choices=[('PENDING', 'PENDING'), ('APPROVED', 'APPROVED'), ('DECLINED', 'DECLINED')], max_length=20)),
                ('submitted_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tracking.newcomplaint')),
            ],
        ),
    ]
